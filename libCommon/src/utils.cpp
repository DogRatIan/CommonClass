...
void TrimTail (char *aStr)
{
    ...
    {
        i --;
        if ((aStr[i] != ' ') && (aStr[i] != 0x0a) && (aStr[i] != 0x0d))
            break;
        aStr[i] = 0;
    }
}
...
// Trim tailing space of a string
//==========================================================================
std::string LTrimStdString (std::string str)
{
    size_t i = 0;
...
// Trim out leading and tailing space
//==========================================================================
std::string RTrimStdString (std::string str)
{
    size_t i = str.size();
...
//==========================================================================
std::string TrimStdString (std::string str)
{
    size_t i = 0;
